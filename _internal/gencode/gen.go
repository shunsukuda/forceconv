...
var (
	typeInfoListForceconv = []tmplTypeInfo{
		...
		{TypeName: "Float32", GoTypeName: "float32", TypeKind: "Float", ZeroValue: "0", SizeOf: 4},
		{TypeName: "Float64", GoTypeName: "float64", TypeKind: "Float", ZeroValue: "0", SizeOf: 8},
		{TypeName: "Complex64", GoTypeName: "complex64", TypeKind: "Complex", ZeroValue: "0", SizeOf: 8},
		{TypeName: "Complex128", GoTypeName: "complex128", TypeKind: "Complex", ZeroValue: "0", SizeOf: 16},
...
func main() {
	set := []tmplSet{
		...
		{Name: "ForceconvTest", Input: "tmpl_forceconv.test.go", Output: "forceconv.gen_test.go", Config: tmplDataForceconv},
	}
